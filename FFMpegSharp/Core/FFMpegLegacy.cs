...
namespace FFMpegSharp.FFMPEG.Legacy
{
    public delegate void ConversionHandler(double percentage);

    public class FFMpegLegacy : FFBase
    {
        /// <summary>
...
/*        public FFMpegLegacy()
        ...
        public FFMpegLegacy(string ffmpeg) {
            _ffmpegPath = ffmpeg;
        }
        ...
        /// <returns>Success state.</returns>
        public bool ToMp4(VideoInfo source, FileInfo output, SpeedProp speed = SpeedProp.SuperFast,
        ...
        private bool RunProcess(Argument args, FileInfo output) {
            return RunProcess(args.ToString(), output);
        }
